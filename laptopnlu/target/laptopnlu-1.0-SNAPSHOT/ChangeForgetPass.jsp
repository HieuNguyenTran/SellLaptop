            ...
            <div class="login-wrap edit-info-wap ">
                <div class="login-content edit-info-conten">
                    ...
                    <div class="login-form title-edit-info">
                        <form action="ForgetPass_Change" method="post">
                            <div class="form-group">
                                <label>Tên đăng nhập:</label>
                                <%ServletContext context5 = request.getServletContext();%>
                                <input name="uname" value="<%=context5.getAttribute("uname")%>" style="font-weight: bold; color: black"
                                       class="au-input au-input--full" type="text">
                            </div>
                            <div class="form-group">
                                <label>Mật khẩu:</label>
                                <%ServletContext context6 = request.getServletContext();%>
                                <input name="pass" style="font-weight: bold;" class="au-input au-input--full" id="pass" type="password"
                                value="<%=context6.getAttribute("pass")%>">
                                <div class="pass fas fa-eye" id="eye"></div>
                            </div>
                            <div class="form-group">
                                <label>Mật khẩu mới:</label>
                                <input name="newpass" value="password"  style="font-weight: bold; color: #999999"
                                       class="au-input au-input--full" type="password" >
                            </div>
                            <div class="form-group">
                                <label>Nhập lại mật khẩu:</label>
                                <input name="renewpass" value="password" style="font-weight: bold; color: #999999"
                                       class="au-input au-input--full" type="password" >
